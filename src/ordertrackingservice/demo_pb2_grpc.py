...
class OrderTrackingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.CreateOrderTracking = channel.unary_unary(
                '/hipstershop.OrderTrackingService/CreateOrderTracking',
                request_serializer=demo__pb2.CreateOrderTrackingRequest.SerializeToString,
                response_deserializer=demo__pb2.CreateOrderTrackingResponse.FromString,
                _registered_method=True)
        self.GetOrderStatus = channel.unary_unary(
                '/hipstershop.OrderTrackingService/GetOrderStatus',
                request_serializer=demo__pb2.GetOrderStatusRequest.SerializeToString,
                response_deserializer=demo__pb2.GetOrderStatusResponse.FromString,
                _registered_method=True)
        self.ListOrderEvents = channel.unary_unary(
                '/hipstershop.OrderTrackingService/ListOrderEvents',
                request_serializer=demo__pb2.ListOrderEventsRequest.SerializeToString,
                response_deserializer=demo__pb2.ListOrderEventsResponse.FromString,
                _registered_method=True)
        self.GetOrderDetails = channel.unary_unary(
                '/hipstershop.OrderTrackingService/GetOrderDetails',
                request_serializer=demo__pb2.GetOrderDetailsRequest.SerializeToString,
                response_deserializer=demo__pb2.GetOrderDetailsResponse.FromString,
                _registered_method=True)
...
class OrderTrackingServiceServicer(object):
    ...
    def CreateOrderTracking(self, request, context):
    ...
    def ListOrderEvents(self, request, context):
...
def add_OrderTrackingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateOrderTracking': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateOrderTracking,
                    request_deserializer=demo__pb2.CreateOrderTrackingRequest.FromString,
                    response_serializer=demo__pb2.CreateOrderTrackingResponse.SerializeToString,
            ),
            'GetOrderStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrderStatus,
                    request_deserializer=demo__pb2.GetOrderStatusRequest.FromString,
                    response_serializer=demo__pb2.GetOrderStatusResponse.SerializeToString,
            ),
            'ListOrderEvents': grpc.unary_unary_rpc_method_handler(
                    servicer.ListOrderEvents,
                    request_deserializer=demo__pb2.ListOrderEventsRequest.FromString,
                    response_serializer=demo__pb2.ListOrderEventsResponse.SerializeToString,
            ),
            'GetOrderDetails': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrderDetails,
                    request_deserializer=demo__pb2.GetOrderDetailsRequest.FromString,
                    response_serializer=demo__pb2.GetOrderDetailsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.OrderTrackingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hipstershop.OrderTrackingService', rpc_method_handlers)
...
class OrderTrackingService(object):
    ...
    @staticmethod
    def CreateOrderTracking(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.OrderTrackingService/CreateOrderTracking',
            demo__pb2.CreateOrderTrackingRequest.SerializeToString,
            demo__pb2.CreateOrderTrackingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrderStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.OrderTrackingService/GetOrderStatus',
            demo__pb2.GetOrderStatusRequest.SerializeToString,
            demo__pb2.GetOrderStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListOrderEvents(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.OrderTrackingService/ListOrderEvents',
            demo__pb2.ListOrderEventsRequest.SerializeToString,
            demo__pb2.ListOrderEventsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrderDetails(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.OrderTrackingService/GetOrderDetails',
            demo__pb2.GetOrderDetailsRequest.SerializeToString,
            demo__pb2.GetOrderDetailsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
