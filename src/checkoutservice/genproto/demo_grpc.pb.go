...
const (
	OrderTrackingService_CreateOrderTracking_FullMethodName = "/hipstershop.OrderTrackingService/CreateOrderTracking"
	OrderTrackingService_GetOrderStatus_FullMethodName      = "/hipstershop.OrderTrackingService/GetOrderStatus"
	OrderTrackingService_ListOrderEvents_FullMethodName     = "/hipstershop.OrderTrackingService/ListOrderEvents"
	OrderTrackingService_GetOrderDetails_FullMethodName     = "/hipstershop.OrderTrackingService/GetOrderDetails"
)
...
type OrderTrackingServiceClient interface {
	// Registers a new order + tracking ID. Should be safe to call multiple times
	// for the same order_id (idempotent behavior is recommended).
	CreateOrderTracking(ctx context.Context, in *CreateOrderTrackingRequest, opts ...grpc.CallOption) (*CreateOrderTrackingResponse, error)
	// Returns the current status and tracking ID for an order.
	GetOrderStatus(ctx context.Context, in *GetOrderStatusRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error)
	// Returns the status/event timeline for an order.
	ListOrderEvents(ctx context.Context, in *ListOrderEventsRequest, opts ...grpc.CallOption) (*ListOrderEventsResponse, error)
	// Returns the order details (items/address) plus current status and events.
...
func (c *orderTrackingServiceClient) CreateOrderTracking(ctx context.Context, in *CreateOrderTrackingRequest, opts ...grpc.CallOption) (*CreateOrderTrackingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrderTrackingResponse)
	err := c.cc.Invoke(ctx, OrderTrackingService_CreateOrderTracking_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderTrackingServiceClient) GetOrderStatus(ctx context.Context, in *GetOrderStatusRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrderStatusResponse)
	err := c.cc.Invoke(ctx, OrderTrackingService_GetOrderStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderTrackingServiceClient) ListOrderEvents(ctx context.Context, in *ListOrderEventsRequest, opts ...grpc.CallOption) (*ListOrderEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListOrderEventsResponse)
	err := c.cc.Invoke(ctx, OrderTrackingService_ListOrderEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderTrackingServiceClient) GetOrderDetails(ctx context.Context, in *GetOrderDetailsRequest, opts ...grpc.CallOption) (*GetOrderDetailsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrderDetailsResponse)
	err := c.cc.Invoke(ctx, OrderTrackingService_GetOrderDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderTrackingServiceServer interface {
	// Registers a new order + tracking ID. Should be safe to call multiple times
	// for the same order_id (idempotent behavior is recommended).
	CreateOrderTracking(context.Context, *CreateOrderTrackingRequest) (*CreateOrderTrackingResponse, error)
	// Returns the current status and tracking ID for an order.
...
func (UnimplementedOrderTrackingServiceServer) CreateOrderTracking(context.Context, *CreateOrderTrackingRequest) (*CreateOrderTrackingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOrderTracking not implemented")
}
func (UnimplementedOrderTrackingServiceServer) GetOrderStatus(context.Context, *GetOrderStatusRequest) (*GetOrderStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOrderStatus not implemented")
}
func (UnimplementedOrderTrackingServiceServer) ListOrderEvents(context.Context, *ListOrderEventsRequest) (*ListOrderEventsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListOrderEvents not implemented")
}
func (UnimplementedOrderTrackingServiceServer) GetOrderDetails(context.Context, *GetOrderDetailsRequest) (*GetOrderDetailsResponse, error) {
...
func _OrderTrackingService_CreateOrderTracking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOrderTrackingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderTrackingServiceServer).CreateOrderTracking(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderTrackingService_CreateOrderTracking_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderTrackingServiceServer).CreateOrderTracking(ctx, req.(*CreateOrderTrackingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderTrackingService_GetOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrderStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderTrackingServiceServer).GetOrderStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderTrackingService_GetOrderStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderTrackingServiceServer).GetOrderStatus(ctx, req.(*GetOrderStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderTrackingService_ListOrderEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListOrderEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderTrackingServiceServer).ListOrderEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderTrackingService_ListOrderEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderTrackingServiceServer).ListOrderEvents(ctx, req.(*ListOrderEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderTrackingService_GetOrderDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrderDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderTrackingServiceServer).GetOrderDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderTrackingService_GetOrderDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderTrackingServiceServer).GetOrderDetails(ctx, req.(*GetOrderDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderTrackingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.OrderTrackingService",
	HandlerType: (*OrderTrackingServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateOrderTracking",
			Handler:    _OrderTrackingService_CreateOrderTracking_Handler,
		},
		{
			MethodName: "GetOrderStatus",
			Handler:    _OrderTrackingService_GetOrderStatus_Handler,
		},
		{
			MethodName: "ListOrderEvents",
			Handler:    _OrderTrackingService_ListOrderEvents_Handler,
		},
		{
			MethodName: "GetOrderDetails",
			Handler:    _OrderTrackingService_GetOrderDetails_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
